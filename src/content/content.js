...
function createStyles() {
  return `
    ...
    *, *::before, *::after {
    ...
    .buddy[data-state="active"] {
      animation: bounce 1.3s ease-in-out infinite;
    }

    .buddy[data-state="idle"] .raccoon {
      animation: breathe 2.8s ease-in-out infinite;
    }

    .buddy[data-kicked="true"] {
      transform: rotate(-8deg) scale(0.97);
    }

    .buddy[data-dragging="true"] {
      transition: none;
      transform: scale(1.03);
      filter: drop-shadow(0 24px 36px rgba(35, 18, 8, 0.28));
    }
    ...
    .badge {
      ...
      border-radius: 999px;
      background: linear-gradient(180deg, #fff2bd, #ffca60);
      color: #5c2d00;
      font: 700 11px/1 "Segoe UI", sans-serif;
      box-shadow: 0 8px 18px rgba(154, 100, 19, 0.22);
      opacity: 0;
      transform: translateY(6px) scale(0.85);
      transition: opacity 180ms ease, transform 180ms ease;
    }

    .buddy[data-state="reward"] .badge {
      opacity: 1;
    ...
    .bubble {
      ...
      transition: opacity 180ms ease, transform 180ms ease;
      pointer-events: none;
      box-shadow: 0 12px 24px rgba(20, 8, 2, 0.2);
    }
    ...
    .spark {
      ...
      height: 8px;
      border-radius: 999px;
      background: radial-gradient(circle, #ffe6a1, #ffb33b 65%, transparent 66%);
      opacity: 0;
    }

    .buddy[data-state="active"] .spark,
    .buddy[data-state="reward"] .spark {
      opacity: 1;
    ...
    .workshop {
      ...
      background:
        radial-gradient(circle at top center, rgba(255, 215, 120, 0.32), transparent 48%),
        linear-gradient(180deg, #77533d, #442c1d 62%, #301d12);
      box-shadow:
        inset 0 2px 0 rgba(255, 241, 218, 0.2),
        0 14px 28px rgba(48, 29, 18, 0.18);
      overflow: hidden;
    }
    ...
    .workshop::before {
      ...
      border-radius: 14px;
      background:
        repeating-linear-gradient(90deg, #79563d 0 14px, #6b4933 14px 28px);
      opacity: 0.92;
    }
    ...
    .progress-fill {
      ...
      background: linear-gradient(90deg, #ffdd84, #ffb655);
      transition: width 260ms ease;
      box-shadow: 0 0 16px rgba(255, 199, 96, 0.4);
    }
    ...
    .buddy[data-state="active"] .raccoon {
      animation: work 0.9s ease-in-out infinite;
    }

    .buddy[data-state="reward"] .raccoon {
    ...
    .tail {
      ...
      height: 46px;
      border-radius: 18px;
      background: linear-gradient(180deg, #c18b5e, #8d5b37);
    ...
    .tail::after {
      content: "";
      position: absolute;
      inset: 7px 5px 6px 5px;
      border-radius: 14px;
      background:
        repeating-linear-gradient(180deg, rgba(91, 50, 26, 0.85) 0 6px, rgba(242, 216, 185, 0.75) 6px 12px);
    }
    ...
    .body {
      ...
      background: linear-gradient(180deg, #c88a57, #9d6139);
      box-shadow: inset 0 3px 0 rgba(255, 231, 199, 0.18);
    }
    ...
    .apron {
      ...
      height: 32px;
      border-radius: 16px;
      background: linear-gradient(180deg, #8fd0c8, #5aa7a0);
    ...
    .head {
      ...
      height: 42px;
      border-radius: 22px;
      background: linear-gradient(180deg, #e5b384, #be7f54);
      box-shadow: inset 0 3px 0 rgba(255, 235, 210, 0.24);
    }
    ...
    .head::after {
      ...
      width: 18px;
      height: 18px;
      border-radius: 4px 16px 5px 16px;
      background: linear-gradient(180deg, #d89d6d, #a86842);
    }
    ...
    .goggles::after {
      ...
      height: 11px;
      border-radius: 999px;
      background: linear-gradient(180deg, rgba(175, 224, 255, 0.9), rgba(105, 154, 188, 0.9));
    ...
    .arm {
      ...
      height: 28px;
      border-radius: 999px;
      background: linear-gradient(180deg, #da9f73, #b9784a);
    ...
    .tool::after {
      ...
      height: 16px;
      border-radius: 5px;
      background: linear-gradient(180deg, #f0f3f6, #96a1a8);
    }
    ...
    .crate {
      ...
      height: 26px;
      border-radius: 9px;
      background: linear-gradient(180deg, #9b6a43, #6e4327);
      box-shadow: inset 0 2px 0 rgba(255, 244, 222, 0.16);
    }
    ...
    .coin {
      ...
      height: 20px;
      border-radius: 999px;
      background: radial-gradient(circle at 30% 30%, #fff1b0, #f3b03e 70%, #a66a13);
      border: 2px solid rgba(255, 236, 190, 0.35);
      opacity: 0;
      transform: scale(0.6);
      transition: opacity 180ms ease, transform 180ms ease;
    }

    .buddy[data-state="reward"] .coin {
      opacity: 1;
      transform: scale(1);
...
function mountBuddy() {
  ...
  const startPosition = resolveAnchorPosition(currentAnchorIndex);
  buddy.style.left = `${startPosition.x}px`;
  buddy.style.top = `${startPosition.y}px`;
  ...
  function updateVisualState() {
    ...
    if (isActive) {
      ...
      momentum = Math.max(8, momentum - 0.6);
    ...
    if (momentum > 88 && rewardTimer > 60) {
      rewardReady = true;
      showMessage("Fresh gadget ready.", 1800);
    }
  }
  ...
  function kickToAnotherSpot() {
    ...
    moveToAnchor(nextAnchorIndex, "Hey. Rude.");
  }
  ...
  function collectReward() {
    ...
    buddy.dataset.state = "active";
    progressFill.style.width = `${momentum}%`;
    showMessage("Momo found 8 shiny bits.", 1600);
  }
  ...
  function onPointerUp(event) {
    ...
    moveToAnchor(nearestIndex, "New spot, same hustle.");
  }
  ...
  scene.addEventListener("click", () => {
    ...
    if (now - lastTapAt < CLICK_KICK_THRESHOLD) {
      ...
      showMessage("Momo squeaks and keeps working.", 1200);
    }
    lastTapAt = now;
  });
  ...
  scene.addEventListener("mouseenter", () => {
    if (rewardReady) {
      showMessage("Tap to collect.", 900);
      return;
    }

    if (Date.now() < activityUntil) {
      showMessage("Momo is in the zone.", 900);
    } else {
      showMessage("Momo is waiting for momentum.", 900);
    }
  });
  ...
  window.setInterval(updateVisualState, 140);
  updateVisualState();
